                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" inputmode="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}">
                            @error('name')
                        ...
                        <div class="form-group mb-3">
                           ...
                           <select name="gender" id="gender" class="form-control value="{{ old('gender') }}" @error('gender') is-invalid @enderror">
                            @error('gender')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" inputmode="numeric" name="birth_place" id="birth_place" class="form-control " value="{{ old('birth_place') }}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="birth_date">Tanggal lahir</label>
                            <input type="date" inputmode="numeric" name="birth_date" id="birth_date" class="form-control @error('birth_date') is-invalid @enderror" value="{{ old('birth_date') }}">
                              @error('birth_date')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="address" id="address" cols="30" row="10" class="form-control @error('address') is-invalid @enderror">{{ old('address') }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="religion" id="religion" class="form-control" @error('religion') is-invalid @enderror value="{{ old('religion') }}">
                        ...
                        <div class="form-group mb-3">
                           ...
                           <select name="education" id="education" class="form-control" @error('education') is-invalid @enderror value="{{ old('education') }}">
