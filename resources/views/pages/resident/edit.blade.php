                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="education" id="education" class="form-control  @error('education') is-invalid @enderror" value="{{ old('education', $resident->education) }}">
                            @error('education')
                                <span class="invalid-feedback">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" inputmode="numeric" name="phone_number" id="phone_number" class="form-control  @error('phone_number') is-invalid @enderror" value="{{ old('phone_number', $resident->phone_number) }}" placeholder="81234567890" required oninput="this.value = this.value.replace(/\D/g, '')" maxlength="11">
                            @error('phone_number')
                                <span class="invalid-feedback">
                                    {{ $message }}
                                </span>
